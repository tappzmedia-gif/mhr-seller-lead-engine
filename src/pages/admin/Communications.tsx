...
export default function Communications() {
  ...
  return (
    <AdminLayout breadcrumbs={[{ label: "Dashboard", href: "/admin/dashboard" }, { label: "Communications" }]}>
        ...
        <div className="w-80 border-r border-slate-200 flex flex-col bg-white shrink-0">
          <div className="p-3 border-b border-slate-100 space-y-3">
            <div className="relative">
              ...
              <Input placeholder="Buscar conversación..." className="pl-9 h-9 bg-slate-50 text-sm" value={searchTerm} onChange={e => setSearchTerm(e.target.value)} />
            </div>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <span className="text-[10px] text-slate-400 shrink-0">{format(new Date(conv.lastDate), "d MMM", { locale: es })}</span>
                    </div>
                        ...
                        <div key={msg.id} className={cn("flex", isOutbound ? "justify-end" : "justify-start")}>
                          <div className={cn("max-w-[70%] space-y-1")}>
                            ...
                            <div className={cn("flex items-center gap-2 text-[10px] text-slate-400 px-1", isOutbound ? "justify-end" : "justify-start")}>
                              ...
                              <span>·</span>
                              <span>{format(new Date(msg.date), "d MMM, h:mm a", { locale: es })}</span>
                  ...
                  <div className="w-72 border-l border-slate-200 bg-white flex flex-col shrink-0 overflow-y-auto">
                    <div className="p-4 border-b border-slate-100">
                      <div className="flex items-center justify-between mb-3">
                        <h3 className="text-sm font-bold text-slate-900">Perfil del Cliente</h3>
                    ...
                    <div className="p-4 border-b border-slate-100 space-y-2">
                      ...
                      <div className="flex items-center gap-2 text-xs">
                        ...
                        <span className="text-slate-600">Último contacto: {profile.lastContact}</span>
                      </div>
                    </div>
                    ...
                    {profile.tags.length > 0 && (
                      <div className="p-4 border-b border-slate-100">
                        <h4 className="text-[11px] font-bold text-slate-500 uppercase mb-2">Etiquetas</h4>
